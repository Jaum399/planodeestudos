const DEFAULT_WHATSAPP_SENDER_NUMBER = '31971481340';
...
// ── Baileys Microservice (SEM API KEY — usa o numero 31971481340 direto) ────────
...
function normalizeWhatsapp(value) {
  ...
  // Aceita formato nacional (DDD + numero) e converte para E.164 Brasil.
...
async function sendWhatsAppReminder({ to, userName, reminderText, dueAt, source = 'jarvis' }) {
  ...
  // 0) Prioridade maxima: Microservico Baileys (sem API key, usa numero 31971481340)
