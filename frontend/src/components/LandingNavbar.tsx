      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          ...
          <div className="hidden md:flex items-center gap-3">
            ...
            <button onMouseEnter={() => preloadRoute('/login')} onFocus={() => preloadRoute('/login')} onClick={() => navigate('/login')} className="btn-secondary text-sm py-2 px-4">
              Entrar
            </button>
            <button onMouseEnter={() => preloadRoute('/register')} onFocus={() => preloadRoute('/register')} onClick={() => navigate('/register')} className="btn-primary text-sm py-2 px-5">
              Criar conta
            </button>
          </div>
      ...
      {isOpen && (
        <div className="md:hidden bg-app-surface border-t border-white/5 px-4 py-4 space-y-3 animate-fade-in">
          ...
          <div className="flex gap-3 pt-2">
            <button onMouseEnter={() => preloadRoute('/login')} onFocus={() => preloadRoute('/login')} onClick={() => navigate('/login')} className="btn-secondary text-sm py-2 flex-1 justify-center">
              Entrar
            </button>
            <button onMouseEnter={() => preloadRoute('/register')} onFocus={() => preloadRoute('/register')} onClick={() => navigate('/register')} className="btn-primary text-sm py-2 flex-1 justify-center">
              Cadastrar
            </button>
          </div>
        </div>
