          ...
          {sent ? (
            ...
            <>
              ...
              <p className="text-gray-400 text-sm mb-7">
                Informe seu email e enviaremos um link individual e seguro para criar uma nova senha.
              </p>
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                <div>
                  <label htmlFor="forgot-email" className="block text-gray-400 text-xs font-medium mb-1.5">E-mail cadastrado</label>
              ...
              <div className="mt-4 rounded-xl border border-primary-500/20 bg-primary-600/10 px-4 py-3 text-xs text-gray-300 leading-relaxed">
                O link será enviado pelo email da plataforma e só pode ser usado uma vez. Se o endereço estiver correto, você verá a confirmação no seu inbox.
              </div>
