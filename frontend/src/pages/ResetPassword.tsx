        ...
        <div className="card-glass rounded-2xl p-8 card-glow">
          ...
          {success ? (
            ...
            <>
              ...
              <p className="text-gray-400 text-sm mb-7">Digite sua nova senha abaixo.</p>
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div>
                  <label className="block text-gray-400 text-xs font-medium mb-1.5">Confirmar nova senha</label>
                  <input
                    type={showPassword ? 'text' : 'password'}
