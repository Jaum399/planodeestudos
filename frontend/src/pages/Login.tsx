...
import { normalizeEmail } from '../utils/formAutomation';

const LOGIN_LAST_EMAIL_KEY = 'ordex.login.lastEmail';

export default function Login() {
  const [email, setEmail] = useState(() => localStorage.getItem(LOGIN_LAST_EMAIL_KEY) || '');
  ...
  const handleSubmit = async (e: FormEvent) => {
    ...
    try {
      ...
      localStorage.setItem(LOGIN_LAST_EMAIL_KEY, normalizedEmail);
          ...
          <form onSubmit={handleSubmit} className="space-y-4" noValidate aria-busy={isLoading}>
            ...
            <div>
              ...
              <p className="text-[11px] text-gray-500 mb-2 leading-relaxed">
                Você receberá um link individual no email da plataforma para redefinir a senha.
              </p>
            ...
            {error && <span id="login-form-error" className="sr-only">{error}</span>}
          </form>
