...
const SUBJECTS = [
  '', 'Cardiologia', 'Pediatria', 'Farmacologia', 'Cirurgia',
  'Clínica Médica', 'Ginecologia', 'Neurologia', 'Infectologia', 'Psiquiatria',
];
    ...
    <div className="space-y-6 animate-fade-in">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          ...
          <p className="text-gray-400 text-sm mt-0.5">Questões comentadas para fixação e simulados</p>
        </div>
        {/* Stats */}
      ...
      <div className="card-glass rounded-2xl p-5 border border-primary-600/20 card-glow">
        <div className="flex flex-col sm:flex-row sm:items-center gap-4">
          ...
          <div className="flex items-center gap-3">
            ...
            >
              {[5, 10, 20, 30, 40].map(n => <option key={n} value={n}>{n}q</option>)}
            </select>
            <button
