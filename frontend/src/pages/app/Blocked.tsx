    ...
    <div className="min-h-screen bg-app-bg flex items-center justify-center p-4">
      <div className="max-w-md w-full text-center">
        ...
        <h1 className="text-2xl font-bold text-white mb-2">
          {reason === 'trial_expired' ? 'Período de teste encerrado' : 'Acesso suspenso'}
        </h1>

        <p className="text-gray-400 mb-8">
          {reason === 'trial_expired'
            ? 'Seu teste gratuito de 7 dias terminou. Assine o plano mensal para continuar acessando todos os recursos.'
        ...
        <div className="bg-app-card border border-primary-500/40 rounded-2xl p-6 mb-6 text-left">
          ...
          >
            ...
            {reason === 'trial_expired' ? 'Assinar agora — R$49,90/mês' : 'Regularizar pagamento'}
          </button>
